...
data_ref <- "/Users/loganclarke/Downloads/WBBGame stats.xlsx"
...
clean_week <- function(week){
  ...
  write_csv(week2, "week_4_game_data.csv")
}
...
#extract only the week total tabs
cumulative <- grep("Cumulative Total", excel_sheets(path = data_ref), value = TRUE)
...
clean_week <- function(week){
  ...
  week1 <- week[c(2, 3, 6, 8, 9, 11, 13:16, 18, 19, 21, 23, 24, 26:28, 30:32, 34, 36)]
  week2 <- week1[c(1, 2, 12, 11, 13, 18, 17, 19, 15, 14, 16, 21, 20, 22, 9, 10, 8, 4, 6, 7, 5, 23, 3)]
  write_csv(week2, "cum_total_07_dec.csv")
}
